...
public class Player : Entity
{
    ...
    public Player_Fall_State fallState {get; private set;}
    ...
    private Coroutine quuedAttackCo;
    ...
    protected override void Awake()
    {
        ...
        jumpState = new Player_Jump_State(this,stateMachine, "jumpFall");
        fallState = new Player_Fall_State(this,stateMachine,"jumpFall");
    ...
    {
        if(quuedAttackCo != null)
        StopCoroutine(quuedAttackCo);

        quuedAttackCo = StartCoroutine(EnterAttackStateWithDelayCo());
    }
